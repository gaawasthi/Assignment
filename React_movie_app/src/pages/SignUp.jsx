  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <section className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-md p-6 bg-black opacity-70 rounded-xl shadow text-white">
          ...
          <form  onSubmit={handleSubmit} className="flex flex-col">
            ...
            {/* <input
              ...
              required
            /> */}
            <button type='submit' className="bg-gradient-to-r from-red-600 to-purple-600 text-white px-8 py-2.5 rounded-lg font-bold hover:from-red-500 hover:to-purple-500 transition-all transform hover:scale-105 shadow-lg">
              Create an account
            </button>
          </form>
